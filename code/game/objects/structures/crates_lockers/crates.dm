...
/obj/structure/closet/crate/footlocker/legion/PopulateContents()
	...
	new /obj/item/clothing/suit/armor/f13/legion/recruit(src)
	new /obj/item/clothing/head/helmet/f13/legion/recruit(src)
	new /obj/item/clothing/mask/bandana/legrecruit(src)
