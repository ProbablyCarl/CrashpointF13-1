...
/proc/spawn_rivers(target_z, nodes = 4, turf_type = /turf/open/water/radioactive, whitelist_area = /area/lavaland/surface/outdoors/unexplored, min_x = RANDOM_LOWER_X, min_y = RANDOM_LOWER_Y, max_x = RANDOM_UPPER_X, max_y = RANDOM_UPPER_Y)
