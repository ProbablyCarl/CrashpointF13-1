		...
		if(src == M)
			...
			switch(water)
				if(THIRST_LEVEL_FULL to INFINITY)
					to_chat(src, "<span class='info'>You're completely hydrated!</span>")
				if(THIRST_LEVEL_LIGHT to THIRST_LEVEL_FULL)
					to_chat(src, "<span class='info'>You're hydrated!</span>")
				if(THIRST_LEVEL_MIDDLE to THIRST_LEVEL_LIGHT)
					to_chat(src, "<span class='info'>You're slightly thirsty.</span>")
				if(THIRST_LEVEL_HARD to THIRST_LEVEL_MIDDLE)
					to_chat(src, "<span class='info'>You could use some water.</span>")
				if(0 to THIRST_LEVEL_DEADLY)
					to_chat(src, "<span class='danger'>You're about to drop dead from dehydration!</span>")

			switch(piss)
				if(PISS_LEVEL_FULL to INFINITY)
					to_chat(src, "<span class='info'>You're about to piss yourself!</span>")
				if(PISS_LEVEL_HIGH to PISS_LEVEL_FULL)
					to_chat(src, "<span class='info'>You need to take a piss!</span>")
				if(PISS_LEVEL_MIDDLE to PISS_LEVEL_HIGH)
					to_chat(src, "<span class='info'>You could take a piss right now.</span>")
				if(PISS_LEVEL_LIGHT to PISS_LEVEL_MIDDLE)
					to_chat(src, "<span class='info'>Your bladder feels nearly empty.</span>")
				if(0 to PISS_LEVEL_LOW)
					to_chat(src, "<span class='danger'>Your bladder is empty!</span>")

			switch(shit)
				if(SHIT_LEVEL_FULL to INFINITY)
					to_chat(src, "<span class='info'>You're about to piss yourself!</span>")
				if(SHIT_LEVEL_HIGH to SHIT_LEVEL_FULL)
					to_chat(src, "<span class='info'>You need to take a piss!</span>")
				if(SHIT_LEVEL_MIDDLE to SHIT_LEVEL_HIGH)
					to_chat(src, "<span class='info'>You could take a piss right now.</span>")
				if(SHIT_LEVEL_LIGHT to SHIT_LEVEL_MIDDLE)
					to_chat(src, "<span class='info'>Your bladder feels nearly empty.</span>")
				if(0 to SHIT_LEVEL_LOW)
					to_chat(src, "<span class='danger'>Your bladder is empty!</span>")
