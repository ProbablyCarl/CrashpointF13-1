/mob/living/simple_animal/hostile/cat_butcherer
	name = "Cat Surgeon"
	desc = "A man with nothing to lose. He sounds rather similar to another individual you know..."
	icon = 'icons/mob/simple_human.dmi'
	icon_state = "cat_butcher"
	icon_living = "cat_butcher"
	icon_dead = "syndicate_dead"
	icon_gib = "syndicate_gib"
	projectiletype = /obj/item/projectile/bullet/dart/catsurgeon
	projectilesound = 'sound/f13other/nyaaman.ogg'
	ranged = 1
