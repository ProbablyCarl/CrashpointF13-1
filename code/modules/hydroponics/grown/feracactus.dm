...
/obj/item/reagent_containers/food/snacks/grown/feracactus
	...
	desc = "Barrel cactus fruit are found on spherical barrel cacti. It is extremely toxic until processed!"
	icon_state = "feracactus"
	filling_color = "#FF6347"

/obj/item/reagent_containers/food/snacks/grown/feracactus/add_juice()
	if(..())
		reagents.add_reagent("ferrapulp", 3 + round((seed.potency / 20), 1))
