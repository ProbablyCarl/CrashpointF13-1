...
// DRUGS MOTHER FUCKER. PUNCH OUT A BEAR!


/datum/reagent/toxin/jetstageone
	name = "Jet Precursor"
	id = "jetstageone"
	description = "The first steps to creating inhaleable Brahmin shit! Highly Toxic!"
	color = "#792300"
	toxpwr = 2.5
	taste_description = "POOP"

/datum/reagent/toxin/jetneedswash
	name = "Unfiltered Unprocessed Jet"
	id = "jetunwashed"
	description = "Unprocessed Jet that first must be washed in order to seperate the byproducts!"
	color = "#792300"
	toxpwr = 2.5
	taste_description = "POOP"

/datum/reagent/toxin/jetwashed
	name = "Washed Unprocessed Jet"
	id = "jetwashed"
	description = "Unprocessed Jet that first must be washed in order to seperate the byproducts!"
	color = "#792300"
	toxpwr = 2.5
...
/datum/reagent/toxin/jetweak
	name = "Processed Jet"
	id = "jetstagetwo"
	description = "Processed Jet that is awaiting either cutting, purification or sublimation! It's quite toxic to simply injest!"
	color = "#792300"
	toxpwr = 5
	taste_description = "Fermented Poop"

/datum/reagent/toxin/jetfuckup
	name = "Ruined Jet"
	id = "ruinedjet"
	description = "Good job. You ruined it! The best you can do with this is make a fake inhaler to fool some idiot!"
	color = "#792300"
	toxpwr = 0.5
	taste_description = "POOP"
...
/datum/reagent/toxin/jetbyproduct
	name = "Jet Byproduct"
	id = "jetbyproduct"
	description = "A byproduct of the Jet-Creation process. It can either be purified or used to cut your stash. It's quite toxic, but you don't really care, do  you?"
	color = "#792300"
	toxpwr = 3
	taste_description = "Disgusting Chemicals"

/datum/reagent/toxin/jetbyproduct
	name = "Jet Washed Byproduct"
	id = "jetwashbyproduct"
	description = "A byproduct of the Jet-Creation process. It's been washed of it's more rampantly dangerous impurity!"
	color = "#792300"
	toxpwr = 3
	taste_description = "Disgusting Chemicals"

/datum/reagent/toxin/jetbyproductpure
	name = "Purified Jet Byproduct"
	id = "jetpurebyproduct"
	description = "A byproduct of the Jet-Creation process. It's been purified using some household cleaning supplements. It's used in the creation of Ultrajet!"
	color = "#792300"
	toxpwr = 3
	taste_description = "Household Cleaners"

// JET FINISHED

/datum/reagent/toxin/jetfinished
	name = "Finished Jet"
	id = "jetfinished"
	description = "Pure good old fashioned Jet fluid! Just like Mama spent all the food caps on! It'll need to be put into a inhaler first!"
	color = "#792300"
	toxpwr = 2.5
	taste_description = "The Wrong Way, Dumb Fuck."


/datum/reagent/toxin/jetfinishedcut
	name = "Finished Cut Jet"
	id = "jetfinishedcut"
	description = "Shitty cut-jet fluid. You wonder if it'll even react properly as an aresol.. Who cares, they won't tell the difference!"
	color = "#792300"
	toxpwr = 2.5
	taste_description = "The Wrong Way, Dumb Fuck."

/datum/reagent/toxin/jetfinishedultra
	name = "Finished UltraJet"
	id = "jetfinishedultra"
	description = "Top Quality, Lab-Made Jet that could fuck up even a Ghoul! Hope you brought a safety buddy! It'll need an inhaler first!"
	color = "#792300"
	toxpwr = 2.5
	taste_description = "The Wrong Way, Dumb Fuck."
...
/datum/reagent/toxin/abraxofluid
	name = "Abraxo"
	id = "abraxocleaner"
	description = "Yummy-Yummy bleach! It'll fucking kill you."
	color = "#792300"
	toxpwr = 8
	taste_description = "Poor decisions"

/datum/reagent/toxin/turpentinefluid
	name = "Turpentine"
	id = "turpentinecleaner"
	description = "Turpentine! Not as yummy as bleach."
	color = "#792300"
	toxpwr = 6
	taste_description = "Poor decisions"